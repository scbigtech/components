...
| `headers`   | --           |                                                                            | `{ key: string; label: string; class: string; type: "string" \| "number" \| "complex"; cellClasses?: (cell: { [key: string]: any; }) => string; sortable?: boolean; filterable?: boolean; editable?: boolean; action?: boolean; }[]` | `[]`                                                                                                                                                                                                                                                                                                                                                            |
